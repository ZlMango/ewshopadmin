<template>
		<div>
				...
				<div class="content px-4">
						...
						<AddSort v-if="showModal" :showModal="showModal" @changeShowModal="changeShowModal" @reloadTable="reload"></AddSort>
						<EditSort v-if="showEditModal" :user_id="user_id" :showEditModal="showEditModal" @changeEditModal="changeEditModal" @reloadTable="reload"></EditSort>
				</div>
		</div>
</template>
...
// 引入添加用户组件
import AddSort from '@/views/sort/components/AddSort.vue'
// 引入编辑用户组件
import EditSort from '@/views/sort/components/EditSort.vue'
// 定义总页数
